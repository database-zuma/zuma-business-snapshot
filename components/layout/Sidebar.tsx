...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-56 flex-col border-r border-border bg-[#0a1f18]">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-none px-3 py-2.5 text-sm font-medium transition-colors ${
                isActive
                  ? "bg-[#00D084]/20 text-[#00D084] border-l-2 border-l-[#00D084]"
      ...
      <div className="border-t border-white/10 px-5 py-4">
        <p className="text-xs text-neutral-400">Zuma Indonesia</p>
        <p className="text-xs text-neutral-500">Business Dashboard v1</p>
      </div>
    </aside>
  );
}
